		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chat GPT",
									"targetURL": "#comravichatgpt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comravichatgpt-display": {
								"semanticObject": "comravichatgpt",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ravi.chatgpt",
									"url": sap.ui.require.toUrl("com/ravi/chatgpt")
								}
							}
						}
					}
